...
class JointBuyingCreatePurchaseOrderWizard(models.TransientModel):
    ...
    def create_purchase_order(self):
        ...
        for line in self.line_ids:
            line.joint_buying_global_product_id.set_joint_buying_local_product_id(
    ...
    def _create_purchase_order(self):
        ...
        for line in self.line_ids:
            ...
            order_line = PurchaseOrderLine.create(order_line_vals)
    ...
    def _check_values(self):
        self.ensure_one()
        if not self.joint_buying_local_supplier_id:
            raise ValidationError(_("You should define a local supplier."))
        self.line_ids._check_values()
